...
func main() {
	...
	r.HandleFunc("/api/public/service-groups", publicHandler.GetServiceGroups).Methods("GET")
	r.HandleFunc("/api/public/service-groups/{id}/uptime", publicHandler.GetServiceGroupUptime).Methods("GET")
	r.HandleFunc("/api/public/service-groups/{id}/members", publicHandler.GetServiceGroupMembers).Methods("GET")
